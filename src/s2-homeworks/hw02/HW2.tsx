...
export const filterAffairs = (affairs: AffairType[], filter: FilterType): AffairType[] => {
    const filterAll = filter === 'all';// need to fix any
    const filteredAffairs = affairs.filter(e => filterAll ? e.priority : e.priority === filter);

    return filteredAffairs;
}
export const deleteAffair = (affairs: AffairType[], _id: number): AffairType[] => { // need to fix any
    const filteredAffairs = affairs.filter(e => e._id !== _id);
...
function HW2() {
    ...
    const deleteAffairCallback = (_id: number) => {
       const deletedAffair = affairs.filter( e => e._id!== _id);
